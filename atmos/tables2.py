...
""" Tables2.py - Make tables  of atmospheric properties   (Python 2)
...
2019 Sep 29  1.1  RLC    Changed polar radius of earth and renamed tables
2022 Mar 20  1.2  RLC    output files are *.output
"""

import sys, math

version = "1.1 (2019 Sep 29)"
greeting = "Tables - A Python 2 program to compute atmosphere tables"
...
def Atmosphere(alt):
    ...
    i=0; j=len(htab)
    while (j > i+1):
        k = (i+j)/2      # this is integer division in Python 2
        if h < htab[k]:
            j = k
        else:
            i = k
